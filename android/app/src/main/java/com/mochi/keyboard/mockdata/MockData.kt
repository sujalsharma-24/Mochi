...
object MockData {
    ...
    val profile = ProfileSummary(
        ...
        stats = listOf(
            ...
            ProfileSummary.Stat(2_400, "Followers"),
    ...
    val profileCreations = listOf(
        ProfileCreation("creation-pastel-rainbow", "Pastel Rainbow", "Theme", "profile_art_pastel_rainbow", 12_500, 3_400),
        ProfileCreation("creation-forest", "Forest Theme", "Theme", "theme_forest", 908, 2_600),
        ProfileCreation("creation-pastel-pink-sky", "Pastel Pink Sky", "Theme", "theme_pastel_pink_sky", 12_500, 3_100),
        ProfileCreation("creation-sweet-handwriting", "Sweet Handwriting", "Font", "font_typewriter_classic", 755, 1_800)
    )
    ...
    val profileDownloads = listOf(
        ...
        ProfileCreation("download-kawaii-boba", "kawaii boba tea", "Theme", "theme_kawaii_boba", 10_000),
        ProfileCreation("download-cozy-sakura-cafe", "Cozy Sakura Café", "Theme", "theme_cozy_sakura_cafe", 12_500)
    )

    val profileLikedThemes = listOf(
        ProfileLikedTheme("liked-pastel-pink-sky", "Pastel Pink Sky", "Vibe Studio", "liked_pastel_pink_sky", 2_100),
        ProfileLikedTheme("liked-pastel-dream", "Pastel Dream", "Dreamy Designs", "liked_pastel_dream", 1_600),
        ProfileLikedTheme("liked-pastel-rainbow", "Pastel Rainbow", "Clean Keys", "liked_pastel_rainbow", 2_300)
    )

    val profileFollowRows = listOf(
        ProfileFollowRow("followers", "Followers", 2_100),
